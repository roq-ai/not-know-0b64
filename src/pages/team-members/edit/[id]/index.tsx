      ...
      <Box bg="white" p={4} rounded="md" shadow="md">
        ...
        {isLoading || (!formik.values && !error) ? (
          ...
          <form onSubmit={formik.handleSubmit}>
            <FormControl id="unique_code" mb="4" isInvalid={!!formik.errors?.unique_code}>
              <FormLabel>Unique Code</FormLabel>
              <Input type="text" name="unique_code" value={formik.values?.unique_code} onChange={formik.handleChange} />
              {formik.errors.unique_code && <FormErrorMessage>{formik.errors?.unique_code}</FormErrorMessage>}
            </FormControl>
